...
import { createUkulele } from "../graphql/mutations";
const client = generateClient();
export default function UkuleleCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createUkulele.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "UkuleleCreateForm")}
      {...rest}
    >
      <TextField
        label="Title"
